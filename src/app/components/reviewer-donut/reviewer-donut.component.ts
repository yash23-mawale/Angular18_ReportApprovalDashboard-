...
import { ReviewerCount } from '../../model/interfaces';

@Component({
  selector: 'app-reviewer-donut',
  standalone: true,
  imports: [],
  templateUrl: './reviewer-donut.component.html',
  styleUrl: './reviewer-donut.component.css'
})
export class ReviewerDonutComponent {

  @Input() chartData:ReviewerCount[]=[]
    ...
    createChart():void{
      // Root
      this.root = am5.Root.new('reviewver_status_div');
